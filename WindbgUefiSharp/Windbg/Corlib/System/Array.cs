...
namespace System
{
    public abstract unsafe partial class Array : System.Collections.IEnumerable
    {
        //[DllImport("*")]
...
#nullable disable
        ...
        public static void Move(Array sourceArray, IntPtr dest, int startIndex, int destIndex,  int count)
        {
            dest = dest + destIndex;

            StartupCodeHelpers.Move(sourceArray, dest, startIndex, count);

        }

        public static void From( IntPtr src, Array sourceArray, int startIndex, int destIndex, int count)
        {
            src = src + startIndex;

            StartupCodeHelpers.From(src,sourceArray, destIndex, count);

        }

        public static void Move(Array sourceArray, IntPtr dest, int startIndex,  int count)
        {
            Move(sourceArray, dest, startIndex, 0, count);
        }
        public static void Move(Array sourceArray, IntPtr dest,  int count)
        {

            Move(sourceArray, dest, 0, 0, count);
        }

        public static void Move(Array sourceArray, Array destinationArray, int startIndex, int destIndex, int count)
        {
            /*
            if (sourceArray == null)
            {
            ...
            */
            ...
            for (int i = startIndex; i < startIndex + count; i++)
            {
                destinationArray[x] = sourceArray[i];
                x++;
            }

        }

        public static void Copy<T>(T[] sourceArray, ref T[] destinationArray, int startIndex, int destIndex, int count)
        {
            /*
            if (sourceArray == null)
            {
        ...
        public static void Move<T>(T[] sourceArray, T[] destinationArray, int startIndex, int destIndex, int count)
        {
            /*
            if (sourceArray == null)
            {
            ...
            */
            if (sourceArray.Length < startIndex + count)
            {
                return;
            }

            if (destinationArray.Length < destIndex + count)
            {
                return;
            }
        ...
        public static void Move<T>(T[] sourceArray, T[] destinationArray, int startIndex, int count)
        {
            Move<T>(sourceArray, destinationArray, startIndex, 0, count);
            return;
        }

        public static void Move<T>(T[] sourceArray, T[] destinationArray, int count)
        {
            Move<T>(sourceArray, destinationArray, 0, 0, count);
            return;
        }
#nullable enable
