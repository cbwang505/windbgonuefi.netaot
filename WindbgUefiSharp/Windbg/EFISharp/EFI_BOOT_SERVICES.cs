...
namespace EfiSharp
{
    ...
    public readonly unsafe struct EFI_BOOT_SERVICES
    {
        ...
        private readonly delegate*<EFI_MEMORY_TYPE, ulong, void**, EFI_STATUS> _allocatePool;
        ...
        private readonly delegate*<EFI_HANDLE, EFI_GUID*, void**, EFI_STATUS> _HandleProtocol;
        ...
        private readonly delegate*<int, EFI_STATUS> _stall;
        ...
        private readonly delegate*<EFI_GUID*, void*, void**, EFI_STATUS> _LocateProtocol;
        ...
        /// </returns>
        public EFI_STATUS AllocatePool(EFI_MEMORY_TYPE poolType, ulong size, out IntPtr buffer)
        {
        ...
        public EFI_STATUS LocateProtocol( EFI_GUID protocol, out void* _interface)
        {
            fixed (void** pInterface = &_interface)
            {
                return _LocateProtocol( &protocol,null, pInterface);
            }
        }
        public EFI_STATUS HandleProtocol(EFI_HANDLE handle, EFI_GUID protocol, out void* _interface)
        {
            fixed (void** pInterface = &_interface)
            {
                return _HandleProtocol(handle, &protocol, pInterface);
            }
        }
        ...
        public EFI_STATUS Stall(int Microseconds)
        {
          return  _stall(Microseconds);
        }


        public void Sleep(int multi)
        {
